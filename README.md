...
- LCD: `include/User_Setup.h`
- EC11: `src/drivers/EncoderEc11.h`
- LED: `src/services/LedCycleService.h`

## BLE Provisioning(선택)

`platformio.ini`에서 `ENABLE_BLE_PROV=1`을 켜면 BLE 프로비저닝을 시작합니다.

- Espressif "WiFi Provisioning" 앱(안드로이드/iOS) 사용
- POP 값은 `src/services/WifiService.cpp`의 `PROV_POP`
